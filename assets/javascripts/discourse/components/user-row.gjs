...
//import Category from "discourse/models/user";
...
export default class UserRow extends Component {
  ...
  get label() {
    //console.log('label', this.args.item);
  ...
  //   return this.user.description_text;
  // }
  ...
  get category() {
    ...
    // }
    return User.findById(parseInt(this.rowValue, 10));
  }
